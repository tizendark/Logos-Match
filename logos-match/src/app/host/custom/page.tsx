      ...
      <main className="w-full max-w-md space-y-4">
        <div className="rounded-2xl bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 flex gap-3">
            <button
              type="button"
              className="flex-1 rounded-xl bg-zinc-950 px-4 py-3 text-sm font-medium text-white disabled:opacity-60"
            ...
            <button
              type="button"
              className="flex-1 rounded-xl bg-zinc-100 px-4 py-3 text-sm font-medium text-zinc-950 disabled:opacity-60"
              onClick={addQuestion}
              disabled={isPending}
            >
              + Pregunta
        ...
        {questions.map((q, qIndex) => {
          ...
          return (
            <div key={qIndex} className="rounded-2xl bg-white p-5 shadow-sm">
              <div className="flex items-center justify-between gap-3">
                <p className="text-sm font-semibold">Pregunta {qIndex + 1}</p>
                <button
                  type="button"
                  className="rounded-lg px-2 py-1 text-xs font-medium text-zinc-600 hover:bg-zinc-50 disabled:opacity-60"
              ...
              <div className="mt-3 space-y-2">
                ...
                <textarea
                  className="w-full resize-none rounded-xl border border-zinc-200 px-3 py-3 text-sm outline-none focus:border-zinc-400"
                  rows={3}
                  value={q.prompt}
                ...
                <div className="space-y-2">
                  {q.options.map((opt, optIndex) => (
                    <div key={optIndex} className="flex gap-2">
                      ...
                      <button
                        type="button"
                        className="shrink-0 rounded-xl bg-zinc-100 px-3 py-2 text-xs font-medium text-zinc-700 disabled:opacity-60"
